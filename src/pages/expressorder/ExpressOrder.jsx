    ...
    <>
      ...
      <div className="accordianWrapper">
        <div className="accordianHeader">
          <KeyboardArrowUpIcon className="accordianArrow" />
          <FlashlightOnIcon className="descArrow" />
          <h1>body care</h1>
        </div>

        <div className="accordianContent " onClick={() =>ShowAccordian()}>
          ...
          <div className="accordianProductContainer" >
            {Data.map((item, i) => {
              ...
              <div className="setShow === i? productItem: showProductItem">
              <img src={item.image} alt="" className="accordianImg" />
             <div className="accordianProductDesc">
               <div className="accordianproductTitle">
                 <h2 className="accordianTitle">{item.title}</h2>
                 <h2 className="accordianPrice">N{item.price}</h2>
               </div>
